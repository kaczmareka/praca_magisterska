...
PATH_MY_GT="../data/articles_categories_my_gt_2.csv"
...
PATH_TWITTER_DATA="../data/tweet-sentiment-extraction/test.csv"
PATH_NEWS_DATA="../data/news_sentiment_dataset/Sentiment_dataset.csv"